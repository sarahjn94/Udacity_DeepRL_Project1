...
Ensure that the Navigation.ipynb is in the same directory as Banana.exe and dqn_agent.py and model.py so that you do not need to change any file paths in the code.